...
def get_recommendations(resume_file, requirement_file, ngram_range=(1, 1),
    ...
    recommender = Recommender(ngram_range=ngram_range, use_tagger=use_tagger, use_stem=use_stem)
    ...
    for resume_file in resume_files:
        for req_file in req_files:
            ...
            missing_requirements, course_recommedations = get_recommendations(
                resume_file, req_file, ngram_range=(1, 1), use_tagger=True, use_stem=False)
